...
{
    public partial class ManageCandidateStatusesForm : Form
    {
        ...
        {
            ServiceHelper.Update(new CandidateStatus
                {
        ...
        private void updateWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                m_region.CandidatesStatuses = tvStatuses.Nodes.ToArray() ;
        ...
        {
            tvStatuses.Nodes.AddRange(m_region.CandidatesStatuses.AsNodeCollection());
