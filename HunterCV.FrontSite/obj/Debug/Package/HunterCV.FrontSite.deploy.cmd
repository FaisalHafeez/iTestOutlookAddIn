...
set _DeploySetParametersFile=%RootPath%HunterCV.FrontSite.SetParameters.xml
)
...
echo. "%MSDeployPath%\msdeploy.exe" -source:archiveDir='%RootPath%Archive' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%HunterCV.FrontSite.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:archiveDir='%RootPath%Archive' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%HunterCV.FrontSite.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%HunterCV.FrontSite.deploy-readme.txt" (
...
start notepad "%RootPath%HunterCV.FrontSite.deploy-readme.txt"
)
echo =========================================================
goto :eof
