...
{
    public partial class ManageStatusesForm : Form
    {
        ...
        public ManageStatusesForm(MainRegion region)
        {
            InitializeComponent();
        ...
        {
            ServiceHelper.Update(new Status
                {
        ...
        private void updateWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                m_region.Statuses = tvStatuses.Nodes.ToArray() ;
                m_region.RefreshStatuses();
                this.Close();
            }
        }
        ...
        {
            tvStatuses.Nodes.AddRange(m_region.Statuses.AsNodeCollection());
